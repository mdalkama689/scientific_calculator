...
const TabShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
   "I found this useful scientific calculator tool, check it out: https://seosaurus.in/tools/scientific-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/scientific-calculator/";
  ...
  return (
    <div className="fixed bottom-20 right-4 z-10">
      ...
      >
        ...
        >
          <Link
            to={`https://wa.me/?text=${whatsappMessage}`}
            target="_blank"
